...
This means it helps in breaking up the relations (the tables with problems) to be smaller relations (to smaller tables).  

**Normal Form**  
It's a condition using keys and functional dependencies of a certain relation to determine to which Normal Form this relation belongs:
